...
export class Oauth2Service {
    ...
    constructor(
        @Inject('Window') private windowdf: Window,
        private http: Http) {
    ...
    public init(config: any) {
        ...
        this.idToken = new Oauth2IdToken(this.windowdf, this.currentConfig);
        this.accessToken = new Oauth2AccessToken(this.idToken, window.location, this.http, this);
    ...
    private buildOauthUrl(path: string) {
        let oAuthScope = (this.currentConfig.scope) ? encodeURIComponent(this.currentConfig.scope) : '',
            ...
            responseType = this.currentConfig.responseType;
